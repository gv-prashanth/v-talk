...
public interface ChatRepository extends JpaRepository<Chat, Integer> {
  ...
  @Query(nativeQuery = true, value = "select * from chats where sender in ?1 and receiver in ?1 and id > ?2 order by created_on asc")
  public List<Chat> findLatestChatsAfterLastPull(Set<String> combined, Integer lastPullChatId);
